...
},{"./template":20,"empty-element":3,"page":13,"title":16,"yo-yo":17}],20:[function(require,module,exports){
...
},{"../layout":23,"../pictures-card":24,"yo-yo":17}],21:[function(require,module,exports){
var page = require('page');
...
},{"./homepage":19,"./singin":25,"./singup":27,"moment":10,"moment/locale/es":9,"page":13}],22:[function(require,module,exports){
var yo = require('yo-yo');
					...
					<div class="col s10 push-s1">
						<div class="row">
							<div class="col m5 hide-on-small-only">
								<img class="iphone" src="iphone.png" alt="Iphone App">
							</div>
							${ box }
						</div>
					</div>
		...
		return yo`<div class="card ${ picture.liked ? 'liked' : '' }">
		    ...
		    <div class="card-content">
		      <a href="/user/${ pic.user.username }" class="card-title">
				<img src="${ pic.user.avatar }" alt="${ pic.user.username }" class="circle avatar" />
